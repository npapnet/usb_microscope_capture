...
This module contains the definition camera device and a concrete implementation of the ABC.

Classes:
    - Camera_GL_USB2_UVC: This is a concrete class that inherits from AbstractCamera. It is expected to provide implementations for the methods declared in AbstractCamera.
...
class Camera_GL_USB2_UVC(AbstractCamera):
    """
